        ...
        <>
            {
                ...
                :
                (
                    <DetailedNavBtn value={value} title={title} width="190px" height="40px" flex="h_center" onMouseOver={exNavBtnHoverEvent} onMouseOut={exNavBtnHoverOutEvent} style={btnStyle}>
                        <img className={className} src={imgSrc} alt={alt} />
                        <DetailedNavName flex="h_start" width="100%" height="20px" fontSize="14px"> {label} </DetailedNavName>
                    </DetailedNavBtn>
                )
            }
        </>
